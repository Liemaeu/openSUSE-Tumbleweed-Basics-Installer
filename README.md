...
Download [this](https://github.com/Liemaeu/openSUSE-Tumbleweed-Basics-Installer/releases/download/1.1/openSUSE.Tumbleweed.Basics.Installer.1.1.tar.gz), extract it, open the extracted folder **openSUSE Tumbleweed Basics Installer 1.0**, click on **Basics Installer.sh** and **Execute**.
